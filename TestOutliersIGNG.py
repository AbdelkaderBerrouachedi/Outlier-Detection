...
if __name__ == '__main__':
    ...
    for ep in range(epochs):
        ...
        print("\repoch [{}/{}] - Train euclidean error : {:.4f} - Test euclidean error : {:.4f} - #num_embryo_neurons: {} - #mature neurons: {} - Epsilon : {:.4f} - Time :{} - Process:{}%"
              .format(ep + 1, epochs, mean_train_error, mean_test_error, num_embryo_neurons, actual_mature_neurons, igng.epsilon, time_since(start), round(ep/epochs*100), 3), end="")

        igng.epsilon = igng.epsilon - igng.epsilon*0.1
