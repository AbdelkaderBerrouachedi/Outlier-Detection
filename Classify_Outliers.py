...
train_data = pd.concat((train_data_1, train_data_2, train_data_4), axis=0)
...
test_data_input = pd.read_csv('data/Synth/Train/2.csv', header=None).iloc[:, :2]
